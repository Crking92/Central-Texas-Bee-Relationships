const CACHE='texas-specialist-bees-v0-1';
const ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','favicon.svg','data/bee_plant_names_families.json','data/bee_plant_names_families.csv','icons/icon-192.png','icons/icon-512.png'];
